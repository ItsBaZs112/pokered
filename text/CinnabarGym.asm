...
_CinnabarGymSuperNerd2AfterBattleText::
	text "I can't help"
	line "stealing other"
	cont "people's KOFFING!"
	done

_CinnabarGymSuperNerd3BattleText::
	text "You can't win!"
	line "I have studied"
	cont "KOFFING totally!"
	done
